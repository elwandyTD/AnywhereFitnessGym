    ...
    <View style={{ flex: 1, backgroundColor: "#0f0f0f" }}>
      <SharedElement id={`item.${item.id}.image_url`}>
        <Image 
          ...
          style={{ width: "100%", height: ITEM_HEIGHT, borderBottomLeftRadius: 20, borderBottomRightRadius: 20 }}
          resizeMode="cover"
        />
      </SharedElement>
      ...
      <ScrollView
        ...
        style={{ paddingHorizontal: 20, backgroundColor: "#0F0F0F" }}
        contentContainerStyle={{ paddingVertical: 20 }}
      >
        <Text style={{ fontSize: 18, color: "#FFF", lineHeight: 24, marginBottom: 4 }}>
